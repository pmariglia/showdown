...
class TestAdaptability(unittest.TestCase):
    ...
    def test_boosts_damage_when_move_type_is_in_pokemon_types(self):
        ...
        self.assertEqual(expected_move, ability_modify_attack_being_used(self.ability_name, move, pkmn, None))
    ...
    def test_does_not_boost_damage_when_it_does_not_need_to(self):
        ...
        self.assertEqual(move, ability_modify_attack_being_used(self.ability_name, move, pkmn, None))
...
class TestAerilate(unittest.TestCase):
    ...
    def test_boosts_move_and_changes_type_to_flying(self):
        ...
        self.assertEqual(expected_move, ability_modify_attack_being_used(self.ability_name, move, None, None))
...
class TestMegaLauncher(unittest.TestCase):
    ...
    def test_mega_launcher_boosts_darkpulse(self):
        ...
        pkmn = MagicMock()
        actual_power = ability_modify_attack_being_used(self.ability_name, move, pkmn, None)[constants.BASE_POWER]
