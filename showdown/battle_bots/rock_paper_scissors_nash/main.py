...
def pick_move_in_equilibrium_from_multiple_score_lookups(score_lookups):
    ...
    logger.debug("Choices: {}, depth={}".format([w for w in weighted_choices if w[1]], config.ShowdownConfig.depth))
...
class BattleBot(Battle):
    ...
    def find_best_move(self):
        ...
        scores = get_payoff_matrix(mutator, user_options, opponent_options, depth=config.ShowdownConfig.depth, prune=False)
