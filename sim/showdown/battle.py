...
from sim.data.parse_smogon_stats import SPREADS_STRING
from sim.data.parse_smogon_stats import ABILITY_STRING
from sim.data.parse_smogon_stats import ITEM_STRING
from sim.data.helpers import get_pokemon_sets
from sim.data.helpers import get_mega_pkmn_name
from sim.data.helpers import PASS_ITEMS
from sim.data.helpers import PASS_ABILITIES
from sim.data.helpers import get_all_likely_moves
from sim.data.helpers import get_most_likely_item
from sim.data.helpers import get_most_likely_ability
from sim.data.helpers import get_most_likely_spread
from sim.data.helpers import get_all_possible_moves_for_random_battle

from sim.showdown.engine.objects import State
from sim.showdown.engine.objects import Side
from sim.showdown.engine.objects import Pokemon as TransposePokemon
    ...
    def get_all_options(self):
        ...
        if force_switch:
            ...
            if (
                ...
                opponent_options = [m.name for m in self.opponent.active.moves if not m.disabled] or [
