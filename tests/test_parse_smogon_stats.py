...
class TestGetSmogonStatsFileName(unittest.TestCase):
    ...
    def test_returns_single_digit_month_properly(self):
        ...
        file_name = get_smogon_stats_file_name('gen7ou')

        self.assertEqual('https://www.smogon.com/stats/2019-05/moveset/gen7ou-0.txt', file_name)
    ...
    def test_works_with_double_digit_month(self):
        ...
        self.assertEqual('https://www.smogon.com/stats/2019-10/moveset/gen7ou-0.txt', file_name)
    ...
    def test_returns_previous_year_properly(self):
        ...
        self.assertEqual('https://www.smogon.com/stats/2018-12/moveset/gen7ou-0.txt', file_name)
