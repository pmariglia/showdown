...
def parse_configs():
    ...
    config.battle_lost_message = env("BATTLE_LOST_MESSAGE", config.battle_lost_message)
    config.battle_won_message = env("BATTLE_WON_MESSAGE", config.battle_won_message)
    config.dynamic_ending_message = env.bool("DYNAMIC_ENDING_MESSAGE", config.dynamic_ending_message)
