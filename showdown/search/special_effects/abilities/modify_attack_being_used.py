...
def speedboost(attacking_move, attacking_pokemon, defending_pokemon):
...
def adaptability(attacking_move, attacking_pokemon, defending_pokemon):
...
def aerilate(attacking_move, attacking_pokemon, defending_pokemon):
...
def compoundeyes(attacking_move, attacking_pokemon, defending_pokemon):
...
def hustle(attacking_move, attacking_pokemon, defending_pokemon):
...
def ironfist(attacking_move, attacking_pokemon, defending_pokemon):
...
def megalauncher(attacking_move, attacking_pokemon, defending_pokemon):
...
def pixilate(attacking_move, attacking_pokemon, defending_pokemon):
    if attacking_move[constants.TYPE] == 'normal':
        attacking_move = attacking_move.copy()
        attacking_move[constants.BASE_POWER] = int(attacking_move[constants.BASE_POWER] * 1.30)
...
def refrigerate(attacking_move, attacking_pokemon, defending_pokemon):
    if attacking_move[constants.TYPE] == 'normal':
        attacking_move = attacking_move.copy()
        attacking_move[constants.BASE_POWER] = int(attacking_move[constants.BASE_POWER] * 1.30)
...
def scrappy(attacking_move, attacking_pokemon, defending_pokemon):
...
def serenegrace(attacking_move, attacking_pokemon, defending_pokemon):
...
def sheerforce(attacking_move, attacking_pokemon, defending_pokemon):
    if attacking_move[constants.SECONDARY]:
        attacking_move = attacking_move.copy()
...
def strongjaw(attacking_move, attacking_pokemon, defending_pokemon):
...
def technician(attacking_move, attacking_pokemon, defending_pokemon):
...
def toughclaws(attacking_move, attacking_pokemon, defending_pokemon):
...
def toxicboost(attacking_move, attacking_pokemon, defending_pokemon):
    if attacking_move[constants.CATEGORY] == constants.PHYSICAL:
...
def hugepower(attacking_move, attacking_pokemon, defending_pokemon):
    if attacking_move[constants.CATEGORY] == constants.PHYSICAL:
        attacking_move = attacking_move.copy()
...
def guts(attacking_move, attacking_pokemon, defending_pokemon):
...
def reckless(attacking_move, attacking_pokeon, defending_pokemon):
...
def rockhead(attacking_move, attacking_pokeon, defending_pokemon):
    if constants.RECOIL in attacking_move:
        attacking_move = attacking_move.copy()
...
def parentalbond(attacking_move, attacking_pokeon, defending_pokemon):
    attacking_move = attacking_move.copy()
    attacking_move[constants.BASE_POWER] *= 1.25
    return attacking_move


def tintedlens(attacking_move, attacking_pokemon, defending_pokemon):
...
def skilllink(attacking_move, attacking_pokemon, defending_pokemon):
...
def ability_modify_attack_being_used(ability_name, attacking_move, attacking_pokemon, defending_pokemon):
